...
<div class="card card-custom formNumbers">
    ...
    <form class="form" method="post" action="{{ URL::to($designElems['mainData']['url'].'/update/'.$contactUs->id) }}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
             <div class="form-group row p-0 m-0 mb-5 pt-5">
                ...
                <div class="col-9">
                    <input type="text" class="form-control" name="name" value="{{$contactUs->name}}" placeholder="{{ trans('Order::order.form.name') }}">
                </div>
            </div>
            <div class="form-group row p-0 m-0 mb-5 pt-5">
                <div class="col-3">
                ...
                <div class="col-9">
                    <input type="email" class="form-control" name="email" value="{{$contactUs->email}}" placeholder="{{ trans('Order::order.form.email') }}">
                </div>
            </div>
            <div class="form-group row p-0 m-0 mb-5 pt-5">
                <div class="col-3">
                ...
                <div class="col-9">
                    <input type="text" class="form-control" name="phone" value="{{$contactUs->phone}}" placeholder="{{ trans('Order::order.form.phone') }}">
                </div>
            </div>
            <div class="form-group row p-0 m-0 mb-5 pt-5">
                <div class="col-3">
                ...
                <div class="col-9">
                    <textarea  class="form-control" name="message" placeholder="{{ trans('Order::order.form.message') }}" cols="30" rows="10">{{ $contactUs->message }}</textarea>
                </div>
            </div>
            <div class="form-group row p-0 m-0 mb-5">
                ...
                <div class="col-9">
                    <span class="switch switch-icon">
                        <label>
                            <input type="checkbox" value="1" name="status" {{$contactUs->status  == 1 ? 'checked' : ''}}/>
                            <span></span>
                        </label>
                    </span>
                </div>
