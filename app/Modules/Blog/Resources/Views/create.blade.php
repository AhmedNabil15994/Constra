    ...
    <form class="form" method="post" action="{{ URL::to($designElems['mainData']['url'].'/create') }}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="tab-content mt-5" id="myTabContent">
                ...
                <div class="tab-pane fade {{$key == 0 ? 'active show' : '' }}" id="home-{{$key+1}}" role="tabpanel" aria-labelledby="home-tab-{{$key+1}}">
                    <div class="form-group row p-0 m-0 mb-5 pt-5">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" name="title_{{$lang['prefix']}}" value="{{old('title_'.$lang['prefix'])}}" placeholder="{{ trans('Section::section.form.title_'.$lang['prefix']) }}">
                        </div>
                    </div>
                    <div class="form-group row p-0 m-0 mb-5 pt-5">
                        <div class="col-3">
                        ...
                        <div class="col-9">
                            <textarea  class="form-control ckeditor5" name="description_{{$lang['prefix']}}" placeholder="{{ trans('Section::section.form.description_'.$lang['prefix']) }}" cols="30" rows="10">{{ old('description_'.$lang['prefix']) }}</textarea>
                        </div>
                    </div>
                </div>
                @endforeach
            ...
            <div class="form-group row p-0 m-0 mb-5 pt-5">
                ...
                <div class="col-9">
                    <input type="number" class="form-control" name="sort" value="{{old('sort')}}" placeholder="{{ trans('Blog::blog.form.sort') }}">
                </div>
            </div>
            ...
            <div class="form-group row p-0 m-0 mb-5">
                ...
                <div class="col-9">
                    <div class="input-group date" id="kt_datetimepicker_1" data-target-input="nearest">
                        <input type="text" name="date" value="{{old('date')}}" class="form-control datetimepicker-input" placeholder="{{ trans('Blog::blog.form.date') }}" data-target="#kt_datetimepicker_1"/>
