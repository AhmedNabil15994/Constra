...
class CompanyCategoryCrudRepository implements DesignInterface
{
    ...
    public function searchData(): array
    {
        return  [
            'parent_id' => [
                ...
                'options' => \App\Entities\CompanyCategory::where('status',1)->get(['id',"name_".LANGUAGE_PREF." as title"]),
            ],
            'status' => [
                'type' => 'toggle',
                'class' => 'form-control datatable-input',
...
//            ],
    ...
    {
        return [
            'title' => trans('CompanyCategory::company-category.title'),
            'url' => 'dashboard/'.'company_categories',
            'name' => 'company-categories',
            'nameOne' => 'company-category',
            'modelName' => 'CompanyCategory',
            'icon' => ' icon-2x la la-group',
            'sortName' => '',
            'addOne' => trans('CompanyCategory::company-category.newOne'),
        ];
    }
