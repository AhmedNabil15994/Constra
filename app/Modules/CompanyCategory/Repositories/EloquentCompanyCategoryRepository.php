...
use App\Entities\CompanyCategory as Model;
use App\Http\Requests\CompanyCategoryValidator as ModelValidator;

class EloquentCompanyCategoryRepository implements EntityRepositoryInterface {
    ...
    public function create($request) {
        ...
        if($request->hasFile('image')){
            $image = \FilesHelper::uploadFile('company_categories',$request->file('image'),$return->id);
    ...
    public function update($request,$id) {
        ...
        if($request->hasFile('image')){
            $updateData['image'] = \FilesHelper::uploadFile('company_categories',$request->file('image'),$id);
        }else{
    ...
    public function delete($id) {
        ...
        if ($record->trashed()){
            \FilesHelper::deleteDirectory(public_path('/').'/uploads/company_categories/'.$id);
