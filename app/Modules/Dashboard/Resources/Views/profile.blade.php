...
@section('title',trans('Dashboard::dashboard.account_setting'))
@section('pageName',trans('Dashboard::dashboard.account_setting'))
...
@include('dashboard.Layouts.breadcrumb',[
    'breadcrumbs' => [
        ...
        [
            'title' => trans('Dashboard::dashboard.account_setting'),
            'url' => \URL::current()
        ],
    ]
])
...
<div class="card card-custom formNumbers">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label"> {{trans('Dashboard::dashboard.account_setting')}}</h3>
        </div>
    </div>
    ...
    <form class="form" method="post" action="{{ URL::current() }}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group row p-0 m-0 mb-5">
                ...
                <div class="col-9">
                    <div class="image-input image-input-empty image-input-outline" id="kt_image_5" style="background-image: url({{ $user->image ? $user->image_url : asset(config('modules.site_configs.default_upload_img'))  }})">
