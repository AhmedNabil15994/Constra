            ...
            <div class="tab-content mt-5" id="myTabContent">
                ...
                <div class="tab-pane fade {{$key == 0 ? 'active show' : '' }}" id="home-{{$key+1}}" role="tabpanel" aria-labelledby="home-tab-{{$key+1}}">
                    ...
                    <div class="form-group row p-0 m-0 mb-5 pt-5">
                        ...
                        <div class="col-9">
                            <textarea  class="form-control" name="description_{{$lang['prefix']}}" placeholder="{{ trans('Section::section.form.description_'.$lang['prefix']) }}" cols="30" rows="10">{{ old('description_'.$lang['prefix']) }}</textarea>
                        </div>
                    </div>
                </div>
                @endforeach
            ...
            <div class="form-group row p-0 m-0 mb-5">
                ...
                <div class="col-9">
                    <select name="page_id" class="form-control" data-toggle="select2">
                        ...
                        <option value="{{$page->id}}" {{$page->id == old('page_id') ? 'selected' : ''}} >{{$page->name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
