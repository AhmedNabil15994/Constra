...
class UserController extends Controller {
    ...
    public function index(Request $request) {
        $designElems = $this->userCrud->getSpecificData(['all']);
        if($request->ajax()){
        ...
        return view('User::index', compact('Users','designElems'));
    }

    public function create() {
        $designElems = $this->userCrud->getSpecificData(['main','add']);
        $permissions = \Helper::getPermissions();
        $roles = Role::get(['id',"name_".LANGUAGE_PREF." as name"]);
        return view('User::create' , compact('designElems','permissions','roles'));
    }
    ...
    public function edit($id) {
        ...
        $designElems = $this->userCrud->getSpecificData(['main','edit']);
        $roles = Role::get(['id',"name_".LANGUAGE_PREF." as name"]);
        $permissions = \Helper::getPermissions();
        return view('User::edit', compact('user','designElems','roles','permissions'));
    }
