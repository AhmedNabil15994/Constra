                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel" aria-labelledby="kt_tab_pane_1">
                            ...
                            <div class="tab-content mt-5" id="myTabContent">
                                @foreach($available_locales as $key => $lang)
                                <div class="tab-pane fade {{$key == 0 ? 'active show' : '' }}" id="homes-{{$key+1}}" role="tabpanel" aria-labelledby="homes-tab-{{$key+1}}">
                                    <div class="form-group row p-0 m-0 mb-5 pt-5">
                                        <div class="col-3">
                                            <label for="inputEmail3">{{ trans('Company::company.form.name_'.$lang['prefix']) }} :</label>                        
                                        </div>
                                        <div class="col-9">
                                            <input type="text" class="form-control" name="name_{{$lang['prefix']}}" value="{{old('name_'.$lang['prefix'])}}" placeholder="{{ trans('Company::company.form.name_'.$lang['prefix']) }}">
                                        </div>
                                    </div>
                                    <div class="form-group row p-0 m-0 mb-5 pt-5">
                                        <div class="col-3">
                                        ...
                                        <div class="col-9">
                                            <textarea  class="form-control" name="description_{{$lang['prefix']}}" placeholder="{{ trans('Company::company.form.description_'.$lang['prefix']) }}" cols="30" rows="10">{{ old('description_'.$lang['prefix']) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                            ...
                            <div class="form-group row p-0 m-0 mb-5">
                                ...
                                <div class="col-9">
                                    <input type="text" id="kt_touchspin_1" min="0"  max="5" class="form-control" name="rate" value="0" placeholder="{{ trans('Company::company.form.rate') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row p-0 m-0 mb-5">
                                ...
                                <div class="col-9">
                                    <input type="text" id="kt_touchspin_2" min="0" class="form-control" name="views" value="0" placeholder="{{ trans('Company::company.form.views') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row p-0 m-0 mb-5">
                                ...
                                <div class="col-9">
                                    <div class="image-input image-input-outline" id="kt_image_5" style="background-image: url({{ asset(config('modules.site_configs.default_upload_img'))  }})">
                        ...
                        <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel" aria-labelledby="kt_tab_pane_2">
                            <div class="form-group row p-0 m-0 mb-5">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="location" value="{{old('location')}}" placeholder="{{ trans('Company::company.form.location') }}">
                                </div>
                            </div>
                            <div class="form-group row p-0 m-0 mb-5">
                                <div class="col-3">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="phone" value="{{old('phone')}}" placeholder="{{ trans('Company::company.form.phone') }}">
                                </div>
                            </div>
                            <div class="form-group row p-0 m-0 mb-5">
                                <div class="col-3">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="whatsapp" value="{{old('whatsapp')}}" placeholder="{{ trans('Company::company.form.whatsapp') }}">
                                </div>
                            </div>
                            <div class="form-group row p-0 m-0 mb-5">
                                <div class="col-3">
                                ...
                                <div class="col-9">
                                    <input type="email" class="form-control" name="email" value="{{old('email')}}" placeholder="{{ trans('Company::company.form.email') }}">
                                </div>
                            </div>
                            <div class="form-group row p-0 m-0 mb-5">
                                <div class="col-3">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="website" value="{{old('website')}}" placeholder="{{ trans('Company::company.form.website') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="kt_tab_pane_3" role="tabpanel" aria-labelledby="kt_tab_pane_3">
                            <div class="form-group row p-0 m-0 mb-5">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="facebook" value="{{old('facebook')}}" placeholder="{{ trans('Company::company.form.facebook') }}">
                                </div>
                            </div>
                            <div class="form-group row p-0 m-0 mb-5">
                                <div class="col-3">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="twitter" value="{{old('twitter')}}" placeholder="{{ trans('Company::company.form.twitter') }}">
                                </div>
                            </div>
                            <div class="form-group row p-0 m-0 mb-5">
                                <div class="col-3">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="instagram" value="{{old('instagram')}}" placeholder="{{ trans('Company::company.form.instagram') }}">
                                </div>
                            </div>
                            <div class="form-group row p-0 m-0 mb-5">
                                <div class="col-3">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="linkedin" value="{{old('linkedin')}}" placeholder="{{ trans('Company::company.form.linkedin') }}">
                                </div>
                            </div>
                        </div>
                    </div>
