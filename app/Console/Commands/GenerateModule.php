...
class GenerateModule extends Command {
    ...
    public function handle() {
        ...
        $attributesCount = (int)$this->ask('enter count of model properties (do not count id,timestamp,softDeletes)');
        while(!$attributesCount){
            $attributesCount = $this->ask('enter count of model properties (do not count id,timestamp,softDeletes)');
        }
        ...
        $dirs = [
            ...
            "Resources","Resources/Views","Resources/Lang","Resources/Lang/ar","Resources/Lang/en","Repositories",
        ...
        $requestStub = str_replace(
            ...
            ['App\\Http\\Requests', $modelName ,$this->generateValidationRules($attributes), $this->generateValidationMessages($attributes) ],
            $requestStub
        );
        ...
        if($hasCrud){
            ...
            file_put_contents("{$modulePath}/Repositories/{$modelName}CurdRepository.php", $crudRepoStub);
