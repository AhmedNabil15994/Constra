...
class FilesHelper {
     ...
     static function setSortInBlogsFirstTime()
    {
    ...
    static function getImagePath($strAction, $id, $filename,$withDefault=true,$tenantId=null) {
        ...
        switch ($strAction) {
            ...
            case "blogs":
                ...
                break;
            case "companies":
                $fullPath = $path . 'uploads' . '/companies/' . $id . '/' . $filename;
                $checkFile = $checkFile . '/companies/' . $id . '/' . $filename;
                return is_file($checkFile) ? $fullPath : $default;
                break;
            case "company_categories":
                $fullPath = $path . 'uploads' . '/company_categories/' . $id . '/' . $filename;
                $checkFile = $checkFile . '/company_categories/' . $id . '/' . $filename;
                return is_file($checkFile) ? $fullPath : $default;
                break;
        }
    ...
    static function uploadFile($strAction, $fieldInput,$id='', $fileType = '') {
        ...
        if ($strAction == 'company_categories') {
            $path = public_path() . '/uploads/';
            $directory = $path . 'company_categories/' . $id;
        }
